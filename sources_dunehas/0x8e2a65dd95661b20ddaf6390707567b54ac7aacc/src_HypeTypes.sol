...
/// @title HypeTypes — shared structs/enums for the Hype perp.
/// @notice All mutable hook state lives in one `HypeState` struct stored once
///         in the hook; external delegate-libraries take `HypeState storage`
///         so their signatures stay clean. See PERP_DESIGN.md.
library HypeTypes {
    enum Side { LONG, SHORT }

    enum Action { SEED_BANDS, OPEN_LONG, OPEN_SHORT, CLOSE, REBALANCE }
