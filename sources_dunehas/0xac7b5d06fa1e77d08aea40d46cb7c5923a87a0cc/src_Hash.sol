...
/*
   ...
   The first mined post-quantum token with a self-hook —
...
contract Hash is ERC20, IHooks, ReentrancyGuard {
    ...
    /// @notice Per-tx unit cap. 5 units × 1,000 HASH = 5,000 HASH per call
    ///         (costs 0.05 ETH). No per-wallet accumulation — a buyer can
